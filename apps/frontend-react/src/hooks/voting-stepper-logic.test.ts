...
const groups: TPositionGroup[] = [
  { id: 'president', title: 'President', description: 'President', candidates: [{ id: 'c1' }, { id: 'c2' }] },
  { id: 'vice-president', title: 'Vice President', description: 'Vice President', candidates: [{ id: 'c3' }, { id: 'c4' }] },
