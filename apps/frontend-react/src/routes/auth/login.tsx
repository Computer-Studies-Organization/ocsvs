        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-12 space-y-6">
            ...
            <div>
              ...
              <p className="text-lg font-medium" style={{ color: "oklch(0.45 0.015 250)" }}>
          ...
          {message && (
            ...
            >
              <p className="text-sm font-bold" style={{ color: "oklch(0.35 0.15 25)" }}>
                {message}
              </p>
            </div>
          )}
          ...
          <div className="mt-10 text-sm font-semibold" style={{ color: "oklch(0.50 0.015 250)" }}>
            New voter?{" "}
            <Link
              to="/auth/register"
      ...
      >
        ...
        <div className="relative z-10 max-w-md space-y-10">
          <div className="space-y-5">
            ...
            >
              Participate in transparent, secure elections that determine the future of the Computer
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-center gap-3">
                ...
                />
                <span className="text-base font-bold" style={{ color: "oklch(0.95 0.005 250)" }}>
                  {feature}
                </span>
              </div>
            ))}
