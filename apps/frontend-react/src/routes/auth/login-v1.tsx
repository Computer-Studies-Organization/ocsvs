    ...
    <div className="min-h-[100dvh] w-full flex">
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(165deg, oklch(0.32 0.09 250) 0%, oklch(0.24 0.07 250) 100%)",
          }}
        />
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          {/* Top - School Logo */}
          <div>
            <img src={aclcLogo} alt="ACLC Logo" className="h-16 w-auto opacity-95" />
          </div>

          {/* Center - CSO Logo & Message */}
          <div className="flex flex-col items-start space-y-8">
            <img src={csoLogo} alt="Computer Studies Organization" className="h-32 w-auto" />
            <div className="space-y-3 max-w-md">
              ...
              <p className="text-lg leading-relaxed" style={{ color: "oklch(0.75 0.02 250)" }}>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center justify-center gap-6 mb-10">
            <img src={aclcLogo} alt="ACLC Logo" className="h-14 w-auto" />
            <div className="h-12 w-px" style={{ background: "oklch(0.85 0.005 250)" }} />
            <img src={csoLogo} alt="CSO Logo" className="h-14 w-auto" />
          </div>
          ...
          <div className="space-y-2 mb-8">
            ...
            <p className="text-base" style={{ color: "oklch(0.50 0.01 250)" }}>
