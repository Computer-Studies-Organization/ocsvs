...
function RouteComponent() {
  ...
  const groupedCandidates = POSITIONS.map((pos) => ({
    ...
    candidates: candidates.filter(
      (c: TCandidate & { percentage: number; voteCount: number }) => c.position === pos,
    ),
  })).filter((group) => group.candidates.length > 0);

  const totalVotes = candidates.reduce(
    (sum: number, c: TCandidate & { voteCount: number }) => sum + c.voteCount,
    0,
  );
  ...
  return (
    <div className="min-h-screen" style={{ background: "oklch(0.16 0.020 250)" }}>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs truncate" style={{ color: "oklch(0.60 0.015 250)" }}>
                    admin@ocsvs.edu
                  </p>
                </div>
              </div>
      ...
      <div className={`transition-all duration-300 ${isSidebarOpen ? "lg:ml-64" : "lg:ml-16"}`}>
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  >
                    {totalCandidates} candidates across
                    {groupedCandidates.length} positions
                  </p>
                </div>
              </div>
        ...
        {/* Stats Bar */}
        <div className="border-b" style={{ borderColor: "oklch(0.25 0.025 250)" }}>
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <div className="p-2 rounded-lg" style={{ background: `${stat.color} / 0.15` }}>
                  ...
                  <p className="text-3xl font-black" style={{ color: "oklch(0.95 0.008 250)" }}>
                    {stat.value}
                  </p>
                </div>
              ))}
          ...
          {isLoadingCandidates ? (
            ...
            >
              <p className="text-sm text-center" style={{ color: "oklch(0.70 0.015 250)" }}>
                ...
                <span className="font-bold" style={{ color: "oklch(0.55 0.15 250)" }}>
                  New Candidate
                </span>{" "}
                to create one.
              </p>
