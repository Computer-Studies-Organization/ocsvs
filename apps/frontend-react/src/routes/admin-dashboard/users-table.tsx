  ...
  return (
    <div className="space-y-4">
        ...
        <Table>
          <TableHeader>
            {table.getHeaderGroups().map((headerGroup) => (
              <TableRow key={headerGroup.id} style={{ borderColor: "oklch(0.25 0.025 250)" }}>
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm font-medium" style={{ color: "oklch(0.70 0.015 250)" }}>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="px-4 py-2 font-bold" style={{ color: "oklch(0.95 0.008 250)" }}>
