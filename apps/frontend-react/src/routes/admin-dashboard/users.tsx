import type { TRegisterUser, TYearLevel } from "@/@types";
import { createFileRoute, useNavigate } from "@tanstack/react-router";
import { ChevronDown, Dices, Eye, EyeOff, Loader2Icon, Menu, UserPlus, X } from "lucide-react";
      ...
      >
        ...
        {isSidebarOpen && (
          <>
            ...
            <div className="p-4 m-4 rounded-xl" style={{ background: "oklch(0.20 0.022 250)" }}>
            ...
            >
              ...
              {modalType === "restore" && (
                <>
                  ...
                  <div className="space-y-4">
                    <p className="font-semibold" style={{ color: "oklch(0.95 0.008 250)" }}>
                      Restore {selectedUser.firstName} {selectedUser.lastName} (
                      {selectedUser.studentId}
                      )?
                    </p>
                    <div className="p-4 rounded-xl" style={{ background: "oklch(0.18 0.022 250)" }}>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setCreateForm({
                              ...createForm,
                              yearLevel: e.target.value as TYearLevel | "",
                            })
                          }
                          className="w-full px-4 py-3 rounded-xl border-2 font-semibold transition-all"
                          style={{
