...
test.describe('Admin Election Ballot Preview UI', () => {
  ...
  test('admin navigates to ballot preview, interacts with simulation, and resets without database mutation', async ({
    ...
    await expect(page.locator('text=You are previewing the exact voter ballot interface')).toBeVisible()
    ...
    await expect(page.locator('text=All ballot steps and selections were successfully completed')).toBeVisible()
