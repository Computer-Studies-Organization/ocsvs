...
export const listPositionsRoute = createRoute({
  ...
  responses: {
    [httpStatusCodes.OK]: jsonContent(z.array(PositionSchema), 'List of positions for the election'),
  },
})
...
export const createPositionRoute = createRoute({
  ...
  responses: {
    [httpStatusCodes.CREATED]: jsonContent(PositionSchema, ERROR_MESSAGES.POSITION_CREATED_SUCCESSFULLY),
    ...
    [httpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(createErrorSchema(CreatePositionBodySchema), 'Validation failed'),
  },
})
...
export const updatePositionRoute = createRoute({
  ...
  responses: {
    ...
    [httpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(createErrorSchema(UpdatePositionBodySchema), 'Validation failed'),
  },
})
...
export const deletePositionRoute = createRoute({
  ...
  responses: {
    [httpStatusCodes.OK]: jsonContent(MessageResponse, ERROR_MESSAGES.POSITION_DELETED_SUCCESSFULLY),
    [httpStatusCodes.FORBIDDEN]: jsonContent(ErrorResponse, ERROR_MESSAGES.FORBIDDEN),
    [httpStatusCodes.NOT_FOUND]: jsonContent(ErrorResponse, ERROR_MESSAGES.POSITION_NOT_FOUND),
