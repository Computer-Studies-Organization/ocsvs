...
const { mockUsernameExists, mockUpdateAccount, mockGetPasswordHash, mockUpdatePassword } = vi.hoisted(() => ({
...
describe('profile Routes', () => {
  ...
  it('should reject profile update with profanity in firstName', async () => {
    mockValidateProfanity.mockReturnValue({ isClean: false, message: 'Profanity detected in First name' })
  ...
  it('should reject profile update with profanity in username', async () => {
    mockValidateProfanity.mockReturnValueOnce({ isClean: true, message: null })
