...
describe('electionQueries', () => {
  describe('getCurrentElection', () => {
    it('returns the open election with positions and active candidates nested', async () => {
      ...
      chain.all.mockReturnValueOnce([
        { id: 'p1', electionId: 'e1', name: 'President', displayOrder: 1, createdAt: 700, updatedAt: 700 },
      ])
      chain.all.mockReturnValueOnce([
        { id: 'c1', fullName: 'Alice', accountId: 'a1', positionId: 'p1', manifesto: 'M', isActive: 1, createdAt: 800, updatedAt: 800 },
      ])
        ...
        positions: [
          {
            ...
            displayOrder: 1,
            candidates: [
              { id: 'c1', fullName: 'Alice', isActive: 1, manifesto: 'M' },
            ],
          },
        ],
      })
  ...
  describe('getElectionWithPositions', () => {
    it('returns the election with positions and active candidates nested', async () => {
      ...
      chain.all.mockReturnValueOnce([
        { id: 'c1', fullName: 'Alice', accountId: 'a1', positionId: 'p1', manifesto: 'M1', isActive: 1, createdAt: 800, updatedAt: 800 },
        { id: 'c2', fullName: 'Bob', accountId: 'a2', positionId: 'p2', manifesto: 'M2', isActive: 1, createdAt: 800, updatedAt: 800 },
      ])
        ...
        positions: [
          {
            ...
            displayOrder: 1,
            candidates: [
              { id: 'c1', fullName: 'Alice', isActive: 1, manifesto: 'M1' },
            ],
          },
          {
            id: 'p2',
            ...
            displayOrder: 2,
            candidates: [
              { id: 'c2', fullName: 'Bob', isActive: 1, manifesto: 'M2' },
            ],
          },
        ],
      })
  ...
  describe('getResults', () => {
    ...
    it('computes percentages per candidate within each position (3/1 votes => 75/25)', async () => {
      chain.all.mockReturnValueOnce([
        { positionId: 'p1', positionName: 'President', candidateId: 'c1', candidateName: 'Alice', voteCount: 3 },
        { positionId: 'p1', positionName: 'President', candidateId: 'c2', candidateName: 'Bob', voteCount: 1 },
      ])
