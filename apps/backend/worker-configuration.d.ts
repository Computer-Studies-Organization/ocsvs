/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 17cd9dfad814e0ad177cdf4eeed23e36)
// Runtime types generated with workerd@1.20260630.1 2026-04-01 nodejs_compat
interface __BaseEnv_CloudflareBindings {
  LOGIN_IP_LIMITER: RateLimit;
  ASSETS: Fetcher;
  NODE_ENV: "staging" | "test" | "development" | "production";
  LOG_LEVEL: "info" | "debug";
  B2_BUCKET_NAME: "cso-voting-candidates-staging" | "cso-voting-candidates";
  B2_PUBLIC_BASE_URL: "https://f003.backblazeb2.com/file";
  B2_PUBLIC_ACCESS: "false";
  TURSO_DATABASE_URL: string | "http://127.0.0.1:8080";
  TURSO_AUTH_TOKEN: string | "offline-local-token";
  TURNSTILE_SECRET_KEY?: string | "1x0000000000000000000000000000000AA";
  HMAC_SECRET: string | "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=";
...
declare namespace Cloudflare {
  ...
  interface StagingEnv {
    ...
    NODE_ENV: "staging";
    LOG_LEVEL: "info";
    B2_BUCKET_NAME: "cso-voting-candidates-staging";
    B2_PUBLIC_BASE_URL: "https://f003.backblazeb2.com/file";
    B2_PUBLIC_ACCESS: "false";
  ...
  interface OfflineEnv {
    ...
    TURSO_AUTH_TOKEN: "offline-local-token";
    HMAC_SECRET: "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=";
    B2_BUCKET_NAME: "cso-voting-candidates";
    B2_PUBLIC_BASE_URL: "https://f003.backblazeb2.com/file";
    B2_PUBLIC_ACCESS: "false";
