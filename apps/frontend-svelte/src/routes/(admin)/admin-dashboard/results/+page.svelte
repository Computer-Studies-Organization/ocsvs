<script lang="ts">
  ...
  import type { TVoteResultsResponse, TVoteResults, TVoteCount } from '$lib/types'
  import { BarChart3, ArrowLeft, Loader, Trophy } from 'lucide-svelte'
  ...
  let resultsWithPercentages = $derived.by<PositionResult[]>(() => {
