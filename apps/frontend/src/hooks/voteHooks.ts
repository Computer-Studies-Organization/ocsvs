...
import { submitVotes, getMyVotes, getVoteResults, getCandidateVoteCount } from "@/api/votes_api";

export const useSubmitVotesMutation = () => {
...
export const useVoteResultsQuery = () => {
    return useQuery({
...
export const useCandidateVoteCountQuery = (candidateId: string | null) => {
    return useQuery({
